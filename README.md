# Bilirubin Monitor (Prototype V1)

![Status](https://img.shields.io/badge/Status-Prototype_Live-green)
![Hardware](https://img.shields.io/badge/Hardware-ESP32_|_IoT-blue)
![Sensors](https://img.shields.io/badge/Sensors-ECG_|_SpO2_|_Temp-red)

## Project Theme & Overview

This project is a **non-invasive, IoT-enabled health monitoring system**. The goal is to create a centralized device that can track vital patient statistics in real-time and transmit them wirelessly to a remote station.

**Current Progress (Prototype V1):**
We have successfully built a fully functional prototype that integrates four distinct environmental and biological sensors. The system runs on a dual-core ESP32 microcontroller, handling data acquisition, local display updates, and a web server simultaneously.
...
* **Dual-View Interface:**
    1.  **OLED Screen:** For the patient/nurse at the bedside.
    2.  **Web Dashboard:** A WiFi-hosted website with **live SVG graphing** of the ECG waveform.
...
**CRITICAL:** This code uses **two separate I2C buses** to prevent sensor conflict. Please wire exactly as shown below.

| Sensor | Pin Name | ESP32 Pin | Connection Type |
| :--- | :--- | :--- | :--- |
...
2.  **Open Code:** Open the file `esp_max_dht11_ecg_oled_complete_code.ino` in Arduino IDE.
3.  **Configure WiFi:**
    * Scroll to lines 13-14 in the code:
        ```cpp
...
4.  Wait for the message: `WiFi Connected! IP Address: 192.168.x.x`.
5.  **Copy that IP address** and paste it into your phone or laptop browser (must be on the same WiFi).
6.  You will see the live dashboard!
...
* **Auto-Refresh:** The page and sensor values update automatically.

---

## 🤝 Credits & License
* **Team Members:** [Mayank Singh](https://github.com/thakurmayanksingh),[Harsh Sharma](_______)
* **License:** Open Source.
